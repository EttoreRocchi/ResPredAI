# Evaluate Command - Detailed Documentation
...
- [Train Command](train-command.md) - Train models (required before evaluate)
- [Run Command](run-command.md) - Full nested CV pipeline for model evaluation
- [Feature Importance Command](feature-importance-command.md) - Extract feature importance from trained models
