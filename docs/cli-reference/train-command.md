# Train Command - Detailed Documentation
...
| `calibrate_threshold` | Yes | Enables threshold calibration |
| `threshold_method` | Yes | Method for threshold calibration |
...
- [Run Command](run-command.md) - Full nested CV pipeline for model evaluation
- [Create Config Command](create-config-command.md) - Configuration file setup
- [Validate Config Command](validate-config-command.md) - Validate configuration before training
